...
/// <summary>
/// Service to manage the interaction with a Captcha Service
/// </summary>
public interface ICaptchaManager
{
    /// <summary>
    /// Site Key to identify the WebApp to the Captcha Service
    /// </summary>
    string? SiteKey { get; }
    ...
    /// This is useful to work with SSR pages where it is not possible to use interactivity to check the captcha directly on the page
    /// </summary>
    /// <returns></returns>
